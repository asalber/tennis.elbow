...
function calculate () {
	...
	echo('tennis.elbow$Pain.Relief.Max <- tennis.elbow$Pain.Relief.Max + round(rnorm(length(tennis.elbow$Pain.Relief.Max),0,0.25))\n');
        ...
        echo('sapply(tennis.elbow$Pain.Relief.Max,fun)\n');
        echo('sapply(tennis.elbow$Pain.Relief.12h,fun)\n');
        echo('sapply(tennis.elbow$Pain.Relief.24h,fun)\n');
        echo('sapply(tennis.elbow$Pain.Relief.Global,fun)\n');
